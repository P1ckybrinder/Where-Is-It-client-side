...
const Navbar = () => {
    ...
    return (
        <div className="sticky top-0 z-50 glass-morphism-dark bg-white/20 text-zetech-primary shadow-2xl px-3 lg:px-8 border-b border-white/30">
            <div className="navbar mx-auto">
                ...
                <div className="navbar-start flex items-center cursor-pointer" onClick={() => navigate('/')}>
                    ...
                    <div className="flex flex-col ml-3">
                        ...
                        <span className="text-xs text-zetech-accent">{schoolConfig.slogan}</span>
                    </div>
                </div>
                ...
                <div className="navbar-end flex items-center space-x-4">
                    {user ? (
                        <div className="dropdown dropdown-end">
                            <button
                                tabIndex={0}
                                className="btn btn-ghost btn-circle avatar hover:bg-zetech-accent/20 transition">
                                <div className="w-10 rounded-full ring-2 ring-zetech-primary">
                                    <img alt={user.email} title={user.displayName} src={user.photoURL} />
                                </div>
                            </button>
                            <ul
                                tabIndex={0}
                                className="menu menu-sm dropdown-content glass-morphism text-zetech-primary rounded-box mt-3 w-52 shadow-2xl">
                                  {links} 
                                {isAdmin && (
                                    <li>
                                        <Link to="/admin" className="font-semibold text-zetech-secondary hover:text-zetech-primary">
                                ...
                                <li><Link to="/addItems" className="hover:text-zetech-primary">Add Lost & Found Item</Link></li>
                                <li><Link to="/allRecovered" className="hover:text-zetech-primary">All Recovered Items</Link></li>
                                <li><Link to="/myItems" className="hover:text-zetech-primary">Manage My Items</Link></li>
                                <li><Link to="/settings/notifications" className="hover:text-zetech-primary">Notification Settings</Link></li>
                                <li>
                                    <button
